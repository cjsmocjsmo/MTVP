...
class Media:
    ...
    def cheechandchong(self):
        self.cursor.execute("SELECT * FROM movies WHERE catagory='CheechAndChong' ORDER BY year DESC")
        return self._fetch_all_as_dict()
    ...
    def clinteastwood(self):
        self.cursor.execute("SELECT * FROM movies WHERE catagory='ClintEastwood' ORDER BY year DESC")
        return self._fetch_all_as_dict()
    ...
    def predator(self):
        self.cursor.execute("SELECT * FROM movies WHERE catagory='Predator' ORDER BY year DESC")
        return self._fetch_all_as_dict()
    ...
    def forallmankinds5(self):
        command = "SELECT * FROM tvshows WHERE catagory='ForAllManKind' AND season='05' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
    ...
    def prehistoricplanets3(self):
        command = "SELECT * FROM tvshows WHERE catagory='PrehistoricPlanet' AND season='03' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
...
#mcu
    ...
    def talesoftheunderworld(self):
        command = "SELECT * FROM tvshows WHERE catagory='TalesOfTheUnderworld' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
    
    def columbia(self):
        command = "SELECT * FROM tvshows WHERE catagory='Columbia' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
...
#NCIS
    ...
    def jetsonss1(self):
        command = "SELECT * FROM tvshows WHERE catagory='Jetsons' AND season='01' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
    
    def jetsonss2(self):
        command = "SELECT * FROM tvshows WHERE catagory='Jetsons' AND season='02' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
    
    def jonnyquests1(self):
        command = "SELECT * FROM tvshows WHERE catagory='JonnyQuest' AND season='01' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
    
    def jonnyquests2(self):
    ...
    def forgedinfires9(self):
        command = "SELECT * FROM tvshows WHERE catagory='ForgedInFire' AND season='09' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
    
    def forgedinfires10(self):
        command = "SELECT * FROM tvshows WHERE catagory='ForgedInFire' AND season='10' ORDER BY Episode ASC;"
        self.cursor.execute(command)
        return self._fetch_all_as_dict()
